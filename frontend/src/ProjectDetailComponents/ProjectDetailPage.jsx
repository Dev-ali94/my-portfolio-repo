    ...
    <Sidebar />
      <main className="bg-[#161B22] p-2  w-full rounded-2xl border-gray-700">
        <div className="text-white space-y-10 overflow-y-auto max-h-[100vh] p-2">
          {/* Hero Section */}
          {project.hero && (
            <div className='bg-gray-900 w-full rounded-3xl mb-8 shadow-md'>
          ...
          <div className="bg-gray-900 flex flex-col p-6 rounded-3xl">
            ...
            <div className="bg-gray-900 p-6 rounded-3xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {project.features.map((feature, index) => (
                  <div key={index} className="bg-gray-800 p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-all">
                    {feature.image && (
            ...
            <div className="bg-gray-900 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {project.technicalstack.map((tech, index) => (
                  <div key={index} className="bg-gray-800 rounded-xl p-5 shadow-md text-center">
                    {tech.image && (
            ...
            <div className="bg-gray-900 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                {project.projectgallery.map((imgObj, index) => (
                  <div key={index} className="rounded-xl overflow-hidden shadow-lg bg-gray-800">
                    <img
                      src={imgObj.image}
                      alt={`Gallery ${index}`}
